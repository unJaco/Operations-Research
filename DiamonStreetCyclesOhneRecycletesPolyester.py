...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 12 10:40:13 2023
...
returnCosts = (sum(remainingMaterial.values()) - remainingMaterial['recyceltes Polyester']) * variables_df.loc[0, 'Rücksendekosten']


## Rückerstattungspreis

returnMoney = sum(quantity * materialMap[matName].costs for matName, quantity in remainingMaterial.items()) - remainingMaterial['recyceltes Polyester'] * materialMap['recyceltes Polyester'].costs
